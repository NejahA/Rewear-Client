...
const Edit = () => {
  ...
  useEffect(() => {
      ...
      console.log();
      // }axios
      // axios.get(""+import.meta.env.VITE_VERCEL_URI+"/api/users/logged", { withCredentials: true })selectedFilesit
      // .then((res) => {
  ...
  const handleUpload = async (e) => {
    ...
    axios
      .put(""+import.meta.env.VITE_VERCEL_URI+"/api/items/" + id, formData, {
        withCredentials: true,
      })
      .then((res) => {
